				   ...
				   <tr>
					<td bgcolor="#353c44" width="100%" height="24px">
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr >
								<td valign="bottom">
									<span class="style1" >Add Test Case</span>
								</td>
							</tr>
						</table>
					</td>
          		...
          		<td>
					...
					<tr>
						<td bgcolor="#ffffff" align="center" width="150px">
							<div class="style2">Case Catagory：</div>
						</td >
						<td bgcolor="#ffffff"  width="150px">
							<div class="style2">
								<s:textfield name="catagory" theme="simple"></s:textfield>
							</div>
						</td >
					</tr>
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">Case Title:</div>
						</td>
						<td bgcolor="#ffffff" width="200px">			
							 <div class="style2">
								<s:textfield name="Title" theme="simple"></s:textfield>
							 </div>
						</td>
					</tr>
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">Case Version:</div>
						</td>
						<td bgcolor="#ffffff" width="200px">			
							 <div class="style2">
								<s:textfield name="Version" theme="simple"></s:textfield>
							 </div>
						</td>
					</tr>
					<tr>
					...
					<tr height="50px">
						<td colspan="2" bgcolor="#ffffff" align="center">
							<div class="style2">
							 <s:submit value="submit" method="addTestCase" theme="simple" onclick="return check();"></s:submit>
							 </div>
						</td>
					</tr>
					</table>
