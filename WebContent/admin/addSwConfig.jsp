...
#txt{
  ...
  <body>
    	<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				   ...
				   <tr>
					<td bgcolor="#353c44" width="100%" height="24px">
						<table width="100%" border="0" align="center" cellpadding="0"
							...
							<tr >
								<td valign="bottom">
									<span class="style1" >Add Software Configuration</span>
								</td>
							</tr>
						</table>
					</td>
          ...
          <tr>
          		<td>
          			<s:form action="swConfigAction" theme="simple">
					<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
					<tr>
						<td bgcolor="#ffffff" align="center" width="150px">
							<div class="style2">BMC Version：</div>
						</td >
					...
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">FRUSDR Version:</div>
						</td>
					...
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">HSC version:</div>
						</td>
						<td bgcolor="#ffffff" width="200px">			
							 <div class="style2">
					...
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">PSU version:</div>
						</td>
						<td bgcolor="#ffffff" width="200px">			
							 <div class="style2">
					...
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">BIOS Version:</div>
						</td>
						<td bgcolor="#ffffff" width="200px">			
							 <div class="style2">
					...
					<tr>
						<td bgcolor="#ffffff" align="center" width="200px">			
							 <div class="style2">ME Version:</div>
						</td>
						<td bgcolor="#ffffff" width="200px">			
							 <div class="style2">
					...
					<tr height="50px">
						<td colspan="2" bgcolor="#ffffff" align="center">
							<div class="style2">
							 <s:submit value="submit" method="addSwConfig" theme="simple" onclick="return check();"></s:submit>
							 </div>
						</td>
					</tr>
					</table>
